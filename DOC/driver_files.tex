...
are; this is controlled via \textcolor{blue}{$USER\_SET/user\_set\_dirs.m$}
...
on textcolor{blue}{USER\_SET/user\_set\_input\_downlook.m}, the file used to generate 
...
\end{verbatim}
All the user has to do is make sure the correct USER\_SET/user\_* files are called,
