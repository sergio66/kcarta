...
examine the "USER\_SET/user\_set*.m" codes in the \textcolor{blue}{Test} subdirectory 
...
the "USER\_SET/user\_set\_input*" files such that they only span $ONE$ spectral
...
\begin{verbatim}
user_set_input_downlook.m        parameters driving driver_dokcarta_downlook_radsNjacs.m
user_set_input_opticaldepths.m   parameters driving driver_dokcarta_opticaldepths.m
\end{verbatim}
...
are; this is controlled via $USER\_SET/user\_set\_dirs.m$
\begin{verbatim}
...
\begin{verbatim}
driver_dokcarta_downlook_radsNjacs.m              compute RT
driver_dokcarta_opticaldepths.m         compute optical depths
\end{verbatim}
